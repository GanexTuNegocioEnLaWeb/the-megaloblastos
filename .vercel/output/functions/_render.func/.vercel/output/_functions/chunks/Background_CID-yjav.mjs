...
const $$Background = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(["", `<div id="large-header" class="large-header" style="height: 340px;"> <canvas id="demo-canvas" width="1366" height="340"></canvas> </div> <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.1/gsap.min.js"><\/script> <script>
  (function() {
    ...
    function initHeader() {
      ...
      // para cada punto, encontrar los 5 puntos m\xE1s cercanos
      ...
      // asignar un c\xEDrculo a cada punto
      for (var i in points) {
    ...
    function drawLines(p) {
      ...
      ctx.strokeStyle = darkMode ? 'rgba(100, 100, 100,' + p.active + ')' : 'rgba(127, 127, 127,' + p.active + ')'; // Cambiar color de l\xEDneas seg\xFAn modo oscuro
      ctx.stroke();
    }
...
}, "C:/ganex/megaloblastos/src/components/UI/Background.astro", void 0);

export { $$Background as $ };
